...
namespace TDShooter.Controllers
{
    ...
    ""controlSchemes"": []
        ...
        private IPicklockGameActions m_PicklockGameActionsCallbackInterface;
        ...
        public struct PicklockGameActions
        {
            ...
            {
                if (m_Wrapper.m_PicklockGameActionsCallbackInterface != null)
                {
                    @PicklockGameStartStop.started -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGameStartStop;
                    @PicklockGameStartStop.performed -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGameStartStop;
                    @PicklockGameStartStop.canceled -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGameStartStop;
                    @PicklockGamePush.started -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGamePush;
                    @PicklockGamePush.performed -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGamePush;
                    @PicklockGamePush.canceled -= m_Wrapper.m_PicklockGameActionsCallbackInterface.OnPicklockGamePush;
                }
                m_Wrapper.m_PicklockGameActionsCallbackInterface = instance;
                if (instance != null)
                {
