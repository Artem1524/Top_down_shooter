...
namespace TDShooter.Controllers
{
    public class ShootController : PlayerComponentController
    {
        ...
        private void OnShootingStarted(CallbackContext ctx)
        {
            ...
            //Quaternion bulletRotation = _bulletSpawner.rotation;
            //Bullet bullet = Instantiate<Bullet>(_bulletPrefab, _bulletSpawner.position, bulletRotation, _bulletPool);
            //bullet.Initialize(transform, 10f, 10f, 1f);
